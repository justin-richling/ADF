        ...
        if main_site_path:
            ...
            for idx, case_name in enumerate(case_names):
                ...
                if case_name in self.__case_web_paths:
                    ...
                    #                         f"{case_dir_ext}_vs_{base_dir_ext}/website/",
        ...
        for web_data in self.__website_data:
            ...
            if not web_data.data_frame:
                ...
                if main_site_path:
                    ...
                    if multi_case_plots:
                        #print("ADF WEB IS IT HERE:",web_data.multi_plot_ext,"ptype",ptype)
                        ...
                        #if (web_data.multi_plot_ext in multi_case_plots.keys()) and (ptype in multi_ptypes):
                        if (web_data.multi_plot_ext) and (multi_case_dict[web_data.multi_plot_ext] in multi_case_plots) and (ptype in multi_ptypes):
                            print("ADF WEB IS IT HERE:",web_data.multi_plot_ext,"ptype",ptype)

...
def amwg_chem_table(adf):
    ...
    data_dirs=[f'{data_root_path2}f.cesm3_cam058_mom_e.FCHIST.ne30_L58.26c_non-orogw_off.001/',
               f'{data_root_path2}f.cesm3_cam058_mom_e.FCHIST.ne30_L58.26c_non-orogw_off.001/']
    #--------------------------------------------------------------------------------------------

...
def aod_panel_latlon(adfobj, plotnames, plot_params, fields, season, obs_name, case_name, case_num, types, symmetric=False):
    ...
    gs = mpl.gridspec.GridSpec(1, plot_len, wspace=0.5, hspace=0.0)
    gs.tight_layout(fig)
    ...
    for i in range(case_num):
        ...
        axs.append(plt.subplot(gs[0:1, start:end], projection=proj))
        axs.append(plt.subplot(gs[1:, start:end], projection=proj))

...
def time_series(adfobj):
    ...
    for season in seasons:
        ...
        for var in ts_var_list:
            ...
            adfobj.add_website_data(plot_name, var, None, web_category, season=season, plot_type="TimeSeries",multi_case=True)
            #Close plots:
            plt.close()

            #If multiple cases, make each individaul case vs baseline time series plot
            # to go into each case website
